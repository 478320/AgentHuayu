package org.huayu.application.conversation.service.message.agent.service;
...
import org.huayu.application.conversation.service.message.agent.analysis.dto.InfoRequirementDTO;
...
import org.huayu.infrastructure.utils.ModelResponseToJsonUtils;
...
public class InfoRequirementService {
    ...
    protected InfoRequirementService(
     ...
     * @return 带有信息完整性状态的CompletableFuture
     */
    private CompletableFuture<Boolean> checkInfoCompleteness(
        ...
        try {
            ...
            // 信息不完整，需要提示用户补充
            log.info("会话[{}]信息不完整，尝试次数:{}/{}，等待用户补充", 
                    sessionId, attemptCount + 1, MAX_INFO_CHECK_ATTEMPTS);
