package org.huayu.application.llm.service;

import org.huayu.application.llm.assembler.ModelAssembler;
import org.huayu.application.llm.assembler.ProviderAssembler;
import org.huayu.application.llm.dto.ModelDTO;
import org.huayu.application.llm.dto.ProviderDTO;
import org.huayu.domain.llm.model.ModelEntity;
import org.huayu.domain.llm.model.ProviderAggregate;
import org.huayu.domain.llm.model.ProviderEntity;
import org.huayu.domain.llm.model.enums.ModelType;
import org.huayu.domain.llm.model.enums.ProviderType;
import org.huayu.domain.llm.service.LLMDomainService;
import org.huayu.infrastructure.entity.Operator;
import org.huayu.infrastructure.llm.protocol.enums.ProviderProtocol;
import org.huayu.interfaces.dto.llm.ModelCreateRequest;
import org.huayu.interfaces.dto.llm.ModelUpdateRequest;
import org.huayu.interfaces.dto.llm.ProviderCreateRequest;
import org.huayu.interfaces.dto.llm.ProviderUpdateRequest;
...
public class LLMAppService {
    ...
    public List<ModelDTO> getActiveModelsByType(ProviderType providerType, String userId, ModelType modelType) {
        List<ProviderAggregate> providersByType = llmDomainService.getProvidersByType(providerType, userId);
        return providersByType.stream()
